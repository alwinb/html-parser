...
import { Any, None, EqClass, printKind, states as S, C }
  from './categories.js'
...
class Frame {
  ...
  constructor (node, rule) {
    ...
    this.id       = None       // element equivalence class-id
