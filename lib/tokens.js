...
// TODO I'd like to already add category annotations here
// In fact maybe even sooner/ in the lexer, as there's a lookup there anyway to check for rawtext/content
...
function TokenBuilder () {
  ...
  Object.defineProperties (this, {
    ...
    state:  { get: $=> ({ output, token, attrs, attr, attname }) } })
...
module.exports = { StartTag, EndTag, Comment, TokenBuilder }