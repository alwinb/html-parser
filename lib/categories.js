...
C.tableContent = 
  E.caption | E.colgroup | C.tbody | E.script | E.template | E.style | C.SPACE | C.hiddenInput

C.trContent = 
  E.script | E.style | E.template | C.cell | C.hiddenInput

C.tbodyContent = 
  E.script | E.style | E.template | C.SPACE | E.tr | C.hiddenInput
