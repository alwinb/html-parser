...
C.bodyContent = 
  ~(E.body | E.html | E.head | E.frameset | E.frame | E.caption | E.colgroup | E.col | C.tbody | E.tr | C.cell | C.DATA)
...
C.framesetOK = 
  ...
  E.frame | E.frameset | E.noframes | E.body // last line, hack it

C.metaRedirect =
  C.meta &~ E.noscript

C.fosterParented =
  ~(C.tableIsh | E.script | E.template | E.style | C.hiddenInput | C.COMMENT | C.SPACE | C.DATA)
