...
const _els =
  ...
  img image noscript title` .split (/\s+/g)
...
C.startTagExceptions =
  E.select | E.image | E.input | E.font | C.annotationXml | E.a | E.body
...
C.framesetOK = 
  ...
  C._void1 | C._block1 | C._block3 | C.other | C.COMMENT | C.SPACE |
