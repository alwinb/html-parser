...
const _cats = {
  ...
  _block2: `listing pre`,
  _block3: `article aside details dir fieldset figcaption
...
C.bodyContent = 
  ~(E.body | E.html | E.head | E.frameset | E.frame | E.caption | E.colgroup | E.col | C.tbody | E.tr | C.cell | C.RAW)
...
C.framesetOK = 
  ...
  C._void1 | C._block1 | C._block3 | E.form | C.other | C.COMMENT | C.SPACE |
  E.html | E.head | C._break | C.hiddenInput | 
  E.svg | E.math | E.frame | E.frameset | E.noframes | E.body // last line, hack it

C.metaRedirect =
  C.meta &~ E.noscript

C.fosterParented =
  ~(C.tableIsh | E.script | E.template | E.style | C.hiddenInput | C.COMMENT | C.SPACE | C.RAW)
