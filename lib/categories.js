...
const _els =
  ...
  a nobr font textarea meta hr style input keygen annotation-xml embed img` .split (/\s+/g)
...
elementFlags.hiddenInput = 1n << i++ // FIXME make it a category, I think?
elementFlags.htmlFont = 1n << i++
elementFlags.annotationHTML = 1n << i++
...
E.annotationXML = E['annotation-xml']
...
C.breakout = 
  ...
  C._fmt0 | E.nobr | C.dddt | C.h1_h6 | C.list | E.embed | E.img | E.hr | E.htmlFont
