import { E, elemIds, C, classIds, Any, None, printKind, states as S, Kind } from './categories.js'
const All = Any
...
const r = []; {
  ...
  //r [e.plaintext] // no corresponding bit yet...
  ...
  r [e.select]    = R.inSelect
  r [e.p]         = R.inParagraph
  r [e.optgroup]  = R.optgroupInFlow
  r [e.option]    = R.optionInFlow
...
log (r.length) // missing two more
for (let i=0; i<r.length; i++)
  if (r[i] === undefined) log (i, 'is empty')
