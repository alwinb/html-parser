...
function Preprocessor (delegate) {
  ...
  let context = { kind:0n, closable:0n, namespace:0n, allOpened:0n, allClosed:0n }
...
function Parser ({ context: ctx = documentRule, verbose = false } = { }) {
  ...
  function feedback (raw = false, _mode = null) {
    ...
    const { closable, namespace, content, kind } = builder.tip
    const r = { namespace, kind, head, body, closable, allOpened, allClosed, raw }
