...
const { elements:E, categories:C, boundaries:B, defaultInfo, info:elementInfo, scopes, schema, $, coset, CoSet }  = require ('./schema.js')
...
function TreeBuilder (delegate) {
  ...
  // (It makes sense to try and handle all 'close' rules here)
