...
const SVGForeignRule = {
  foreign: false,
  // NB. note that most all other rules disallow closing svg elements!
  allowEnd: E.svg,  
  escalate: C.none,
  content: C.bodyContent,
}
...
const tableRule = {
  ...
  // but start tags should -- indeed, start- and end-tags are fostered differntly
  allowEnd: C.none,
  escalate: E.table,
  content: C.tableContent,
  openFor: E.col | E.tr | C.cell,
    paths: { col:'colgroup', tr:'tbody', td:'tbody', th:'tbody' },
  foster: ~(E.table | E.col | E.tr | C.cell | E.svg | E.math)
}
...
const tbodyRule = {
  ...
  foster: ~(C.tbody | C.cell | E.table | E.colgroup | E.col  | E.caption | E.svg | E.math)
}
...
const trRule = {
  ...
  content: C.trContent,
  foster: ~(E.table | C.tbody | E.tr | E.colgroup | E.col | E.caption | E.svg | E.math)
}
...
const colgroupRule = {
  ...
  foster: ~(E.table | C.tbody | E.tr | E.colgroup | C.cell | E.colgroup | E.svg | E.math)
}
