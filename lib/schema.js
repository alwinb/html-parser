...
const tbodyRule = {
  allowEnd: E.table,
  allowOpen: E.table | E.caption | E.colgroup | E.col | C.tbody,
...
const trRule = {
  ...
  allowOpen: E.table | E.caption | E.colgroup | E.col | C.tbody | E.tr,
  content: C.trContent,
...
const tcellRule = {
  ...
  allowOpen: E.table | E.caption | E.colgroup | E.col | C.tbody | E.tr | C.cell,
  content: C.bodyContent,
}
