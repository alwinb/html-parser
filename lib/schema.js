...
const selectInTableRule = {
  allowEnd: C.tableIsh,
  allowOpen: C.closeSelect | C.tableIsh,
  content: E.option | E.optgroup | E.script | E.template | C.TEXT | C.SPACE,
  // TODO should ignore \x00 characters
}
...
const tbodyRule = {
  allowEnd: E.table,
  allowOpen: E.colgroup | E.col | E.table | C.tbody | E.caption,
...
const trRule = {
  ...
  allowOpen: E.colgroup | E.col | E.table | C.tbody | E.tr | E.caption,
  content: C.trContent,
...
const tcellRule = {
  ...
  allowOpen: E.colgroup | E.col | E.table | C.tbody | E.tr | C.cell,
  content: C.bodyContent,
}
...
const liRule = {
  allowEnd: ~(E.option | E.optgroup | C.other),
  forbid: E.li,
  allow: C.h1_h6 | C.dddt | E.option | E.optgroup,
}

const ddRule = {
  allowEnd: ~(E.option | E.optgroup | C.other),
  forbid: C.dddt,
  allow: C.h1_h6 | E.li | E.option | E.optgroup,
}

const headingRule = {
  allowEnd: ~(E.option | E.optgroup | C.other),
  forbid: C.h1_h6,
  allow: E.li | C.dddt | E.a | E.option | E.optgroup,
}
...
const specialBlockRule = {
  allow: C.h1_h6 | E.li | E.a | C.dddt | E.option | E.optgroup,
}
...
const svgRules = {
  ...
  desc: bodyRule, // FIXME in table, add table-like things to allowOpen
  title: bodyRule,
...
function getRule ({ closable }, name, flags) {
  ...
  if (flags & E.option)
    return closable & E.select ? selectOptionRule : optionRule
