...
C.breakout = 
  E.body | E.br | E.head | E.li | E.p | E.table | E.div | C._block1 | C._break | E.meta | C._format0 | C.dddt | C.h1_h6 | C.list | C._void3
...
// currently the only restrictions are E.li, C.h1_h6, C.dddt
...
function getRule ({ node, closable }, name, flags) {

  if (closable & C.foreign) {
    const rules = closable & E.svg ? svgRules
      : closable & E.svg ? mathRules : mainRules
    ...
    return closable & E.select ? selectOptionRule : defaultRule // mainRules.option
