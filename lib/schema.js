...
// * properties:
//   namespace, content, openFor, paths, foster
//   where namespace and content are inherited if absent,
//   and paths and foster, are reset to None if absent.
...
function getRule ({ namespace, closable }, name, kind, allSeen) {
  ...
  if (namespace & E.math)
    return kind & E.annotationHTML ? embeddedHtmlRule
...
module.exports = { 
  ...
  defaultRule, afterHeadRule, afterFramesetRule, getRule
}