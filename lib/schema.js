...
function siblingRule ({ kind:pkind, children }, name, kind) {
  if (pkind === None)
    return children & E.html ? afterHtmlRule : beforeHtmlRule

  if (pkind & E.html)
    return children & E.frameset ? afterFramesetRule
      : children & E.body ? afterBodyRule
      : children & E.head ? afterHeadRule
      : beforeHeadRule
