...
const _cats = 
  `other meta format h1_h6 spec0 spec1 cell closeS scope0
  _reopen list closeP tbody dddt TEXT` .split (/\s+/g)
...
const _categories = {
  ...
  scope0: `applet marquee object`,
  _reopen: `area br embed img wbr keygen input xmp math svg`, // add scope0, format, text, a* nobr* other
  ...
  closeP: `aside blockquote center details dir dl fieldset figcaption
           ...
           plaintext pre section summary xmp
           article dialog`,
           // Add C.spec1, C.heading, E.table and C.list to get all p-closers
...
const scope = 
  E.html | E.template | E.caption | E.table | C.cell | C.scope0

const reopen = 
  E.select | E.optgroup | E.option | E.button | C.scope0 | C.other | C._reopen
...
// Properties are 'content', 'scopeFor', 'closeFor', 'allowEnd' and 'openFor'.
...
const formattingRule = {
  scopeFor: C.h1_h6 | E.option | E.optgroup | C.closeS, // REVIEW
  allowEnd: any,
}
...
const listRule = {
  ...
  allowEnd: tableIsh | C.list | E.button | E.select | C.spec0 | C.dddt | C.spec1 | C.h1_h6 | scope,
}
...
// Foreign content (TODO, implement properly)

const foreignContentRule = {
  scopeFor: 0, // REVIEW
  closeFor: E.body | E.head | E.table | C.list | E.li | E.p | C.h1_h6 | C.dddt | C.format,
  allowEnd: any,
  content: any,
}
...
const mainRules = {
  ...
  button: {
    scopeFor: C.h1_h6 | E.option | E.optgroup | C.closeS | E.li,
    closeFor: E.button,
    allowEnd: tableIsh | C.list | E.button | E.select | C.spec0 | C.spec1 | C.dddt | C.h1_h6 | scope | E.li,
  },
