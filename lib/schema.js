...
function siblingRule ({ kind:pkind, children }, name, kind, _allOpened) {
  ...
  if (pkind & E.html)
    return children & E.frameset ? R.inHtmlAfterFrameset
      : children & E.body ? R.inHtmlAfterBody
      : children & E.head ? R.inHtmlAfterHead
      : R.inHtmlBeforeHead
...
const selectRules = {
  option: R.inOptionInSelect,
  optgroup: R.inOptgroupInSelect,
}
