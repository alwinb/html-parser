...
const _cats = {
  ...
  dddt:    `dd dt`,
  TEXT:    `#text`,
  SPACE:   `#space`, // TODO modify rules for this
...
const tableRule = {
  allowEnd: C.none,
  allowOpen: C.none,
  content: E.caption | E.colgroup | C.tbody | E.script | E.template | E.style | C.SPACE, // TODO add input[type=hidden]
...
const tbodyRule = {
  allowEnd: E.table,
  content:  E.tr | E.script | E.template | C.SPACE,
