...
const _info = {
  ...
  'iframe noembed textarea':         C.special | B.select,
  ...
  '<default>': B.select      // Select element boundary is a coset
}
...
const rules = {
  ...
  '<default>': {
    ...
    negate: true, // allowed represents a cofinite set (i.e. a blacklist)
    allowed: E.head | E.frame | E.caption | E.colgroup | E.col | C.tbody | E.tr | C.cell,
    recover: 'ignore'
  },
  ...
  table: {
    //allowed: set ('caption colgroup tbody tfoot thead script template'),
  ...
  // 'select<inbody>' and 'optgroup<inbody>'
  ...
  optgroup: { // TODO use <default> when not in select scope
...
module.exports = { elements, categories, boundaries, info, defaultInfo, boundarySets, defaultBoundarySet, rules, }