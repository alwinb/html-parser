...
C.void =
  C._void0 | C._void1 | E.input | E.keygen | C._void3 | C._meta0 | E.meta | E.br | E.col | E.frame | E.hr | E.hiddenInput
...
C.reformat =
  C._void0 | E.input | E.keygen | C._scope | C.other | C.format |
...
C.breakout = 
  E.body | E.br | E.head | E.li | E.p | E.table | E.div | C._block1 | C._break | E.meta | C._fmt0 | E.nobr | C.dddt | C.h1_h6 | C.list | C._void3 | E.hr
...
// The 'foreign' flag is experimenta; it is added because the
...
const tableRule = {
  // Ok, so new issue: svg end tags should not be fostered,
  // but start tags should -- indeed, start- and end-tags are fostered differently 
  // UPDATE or now, it can maybe be handled by changing the props of the fosterStack
  allowEnd: C.none,
  escalate: E.table,
  content: C.tableContent | E.hiddenInput,
  openFor: E.col | E.tr | C.cell,
    paths: { col:'colgroup', tr:'tbody', td:'tbody', th:'tbody' },
  foster: ~(E.table | E.col | E.tr | C.cell)
}
...
const tbodyRule = {
  ...
  foster: ~(C.tbody | C.cell | E.table | E.colgroup | E.col  | E.caption)
}
...
const trRule = {
  ...
  content: C.trContent,
  foster: ~(E.table | C.tbody | E.tr | E.colgroup | E.col | E.caption)
}
...
const colgroupRule = {
  ...
  foster: ~(E.table | C.tbody | E.tr | E.colgroup | C.cell | E.colgroup)
}
