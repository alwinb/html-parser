...
// const annotationXmlRule = { name: 'annotationXmlRule', content:C.none, escalate:C.none }

function getRule ({ foreign, closable }, name, flags) {

  if (foreign) {
    if (closable & E.math)
      return flags & E.annotationHTML ? mathForeignRule : mathRules [name] || foreignRule
    return svgRules [name] || SVGForeignRule
  }
