...
const _unclosable =
  ...
  C.VoidElement | C.RcDataElement | C.RawTextElement | C.html | C.body

const hideInFlow = 
   ~(C.table | C.Tabular | C.button | C.Applet | C.SpecialBlockElement /*| C.OtherFmt*/) | C.form | C.p
   // form and p are in SpecialBlockElement, button and object are not
...
const Rules = {
  ...
  inApplet: { // applet, object, marquee
  ...
  inPhrasing: {
    ...
    hide: ~(C.table | C.Tabular | C.button | C.Applet | C.SpecialBlockElement) | C.form,
  ...
  optionInPhrasing: {
    state: S.main | S.inPhrasing,
    hide: C.ForeignElement | C.html | C.body,
    escalate: C.frameset | C.Tabular | C.optgroup | C.Heading | C.SpecialBlockElement,
  ...
  inSvg: {
    state: S.inSvg,
    hide: C.form,
    escalate: C.frameset | C.Tabular | C.BreakoutElement, // REVIEW
  ...
  inEmbeddedXml: {
    ...
    escalate: C.BreakoutElement | C.frameset, // REVIEW
    content: C.ForeignElement | C.SPACE | C.TEXT | C.COMMENT,
  },
...
const r = []; {
  ...
  //r [c.plaintext] // in c.OtherBlock instead
  ...
  // ForeignElement namespaces, these should
