...
const eqClass = (() => {
  ...
  const
    [ nul, cr, lf, rest, quot, squo, space, term, hash, amp, eq, que, excl, dash, lt, gt, slash, digit, A_F, G_WYZ, X ] = range (1)
...
const [
  ...
  RLTs, LXD, DD, DX,
  AmpH, AmpX, TOP,
  Nul, Wsp, CR, Tsp, Wrd, Oth, Raw, Rcd, Att,
  Val, ValQ, ValS,
...
const states = {
  ...
  BeforeAttribute, BeforeAssign, BeforeValue,
  BeforeCommentData, InCommentData, Bogus,
  ValueQuoted, ValueAposed, ValueUnquoted, STOP
}
...
[ 0,               Val,  ___,  ___,  Val,  lQ_,  Sq_,  ___,  Val,  Val,  Amp,  Val,  Val,  Val,  Val,  Val,  TagE, Val,  Val,  Val,  Val,  Val  ], // BeforeValue
...
[ 0,               ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  dRef, ___,  ___,  AmpX ], // AmpH:  after &#x or &#X
[ 0,               ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  xRef, xRef, ___,  ___  ], // AmpX:  after &#
...
[ other,           ___,  ___,  ___,  Oth,  Oth,  Oth,  ___,  Oth,  Oth,  ___,  Oth,  Oth,  Oth,  Oth,  ___,  Oth,  Oth,  ___,  ___,  ___,  ___  ], // Oth    non-alphanumeric
