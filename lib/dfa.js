...
[ startTagStart_,  STN,  ___,  ___,  STN,  STN,  STN,  ___,  STN,  STN,  STN,  STN,  STN,  STN,  STN,  STN,  ___,  ___,  STN,  STN,  STN,  STN,  STN,  STN,  STN ], // STN    after <A  -- non-normal
[ endTagStart_,    ETN,  ___,  ___,  ETN,  ETN,  ETN,  ___,  ETN,  ETN,  ETN,  ETN,  ETN,  ETN,  ETN,  ETN,  ___,  ___,  ETN,  ETN,  ETN,  ETN,  ETN,  ETN,  ETN ], // ETN    after </A -- non-normal
[ startTagStart,   STN,  ___,  ___,  stn,  stn,  stn,  ___,  stn,  stn,  stn,  stn,  stn,  stn,  stn,  stn,  ___,  ___,  stn,  STN,  STN,  STN,  stn,  stn,  stn ], // stn    after <a  -- normal
[ endTagStart,     ETN,  ___,  ___,  etn,  etn,  etn,  ___,  etn,  etn,  etn,  etn,  etn,  etn,  etn,  etn,  ___,  ___,  etn,  ETN,  ETN,  ETN,  etn,  etn,  etn ], // etn    after </a -- normal
