...
const {
  ...
  nulls, space, newline, ampersand, lt,
  ...
  startTagStart, endTagStart,  startTagStart_, endTagStart_, tagEnd,
  attributeSep, attributeSepNL, tagSpace, tagSpaceNL, 
...
const [
  ...
  RLTs, LXD, DD, DX,
  AmpH, AmpX, TOP,
  Nul, Wsp, BeforeValue, CR, 
  
  Tsp, TspCR, Sep, SepCR, Vsp, VspCR,
  
  Wrd, Raw, Rcd, Att, att, Val, ValQ, ValS,
  Bog, Cmt, CmtD, CmtSD,
  Amp, Ref, xRef, dRef,
  LT, LTs, LTx,
  STN, ETN, stn, etn, DTN,
  RawLT, RcdLT, Eq, LXDD, 
  TagE, Bog_, Cmt_,
  lQ_, Sq_, rQ_, nRef_, dRef_, xRef_, NL_, TspNL, SepNL
...
[ 0,               Att,  SepCR,SepNL,att,  att,  att,  Sep,  att,  att,  att,  att,  att,  att,  att,  att,  TagE, Sep,  att,  Att,  Att,  Att,  att,  att,  att ], // BeforeAttribute
[ 0,               Att,  TspCR,TspNL,att,  att,  att,  Tsp,  att,  att,  att,  Eq,   att,  att,  att,  att,  TagE, Sep,  att,  Att,  Att,  Att,  att,  att,  att ], // BeforeAssign
...
[ 0,               Val,  SepCR,SepNL,Val,  Val,  Val,  Sep,  Val,  Val,  Amp,  Val,  Val,  Val,  Val,  Val,  TagE, Val,  Val,  Val,  Val,  Val,  Val,  Val,  Val ], // ValueUnquoted
...
[ unquoted,        Val,  VspCR,TspNL,Val,  lQ_,  Sq_,  Vsp,  Val,  Val,  Amp,  Val,  Val,  Val,  Val,  Val,  TagE, Val,  Val,  Val,  Val,  Val,  Val,  Val,  Val ], // BeforeValue
[ newline,         ___,  ___,  NL_,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___ ], // CR     after CR
[ tagSpace,        ___,  TspCR,TspNL,___,  ___,  ___,  Tsp,  ___,  ___,  ___,  Eq,   ___,  ___,  ___,  ___,  TagE, Sep,  ___,  ___,  ___,  ___,  ___,  ___,  ___ ], // Tsp    after space after attname
[ tagSpaceNL,      ___,  ___,  TspNL,___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___ ], // TspCR  after space + CR after attname
[ attributeSep,    ___,  SepCR,SepNL,___,  ___,  ___,  Sep,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  TagE, Sep,  ___,  ___,  ___,  ___,  ___,  ___,  ___ ], // Sep    after space between attrs
[ attributeSepNL,  ___,  ___,  SepNL,___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___ ], // sepCR  after CR between attrs
[ tagSpace,        ___,  VspCR,TspNL,___,  ___,  ___,  Vsp,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  TagE, Sep,  ___,  ___,  ___,  ___,  ___,  ___,  ___ ], // Vsp    after space after =
[ tagSpaceNL,      ___,  ___,  TspNL,___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___ ], // VspCR  after CR after =
...
[ tagSpaceNL,      ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___ ], // TspNL  after CRLF or LF after attname
[ attributeSepNL,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___,  ___ ], // SepNL  after CRLF or LF between attrs
//                 nul   CR    LF    other  "     '    \s     ;     #     &     =     ?     !     -     <     >     /    0-9   A-F   G-WYZ  X    a-f   g-wyz  x  ;
]
